...
const articleCatalog: Article[] = [
  ...
  {
    slug: "comment-choisir-veterinaire-criteres",
    title: "Comment choisir son vétérinaire : 8 critères qui comptent vraiment",
    description:
      "Proximité, urgences, spécialités, tarifs : nos conseils pour trouver le vétérinaire qui suivra votre animal sur la durée.",
    metier: "veterinaire",
    date: "2026-05-22",
    readTime: 6,
    intro:
      "Choisir son vétérinaire, ce n'est pas seulement choisir le cabinet le plus proche. C'est sélectionner un partenaire de santé pour la vie de votre animal — souvent dix à quinze ans. Voici les 8 critères qui font vraiment la différence.",
    sections: [
      { type: "h2", text: "1. Proximité et accessibilité" },
      {
        type: "p",
        text: "Pour le suivi régulier (vaccins, contrôles annuels), un vétérinaire à moins de 15 minutes en voiture est un confort réel. Pour un chat anxieux ou un chien malade, chaque trajet est une épreuve : limiter la distance évite d'aggraver le stress. Vérifiez aussi la disponibilité d'un parking et l'accessibilité PMR si nécessaire.",
      },
      { type: "h2", text: "2. Gestion des urgences" },
      {
        type: "p",
        text: "Un bon cabinet vous indique clairement la procédure en cas d'urgence hors horaires : numéro d'astreinte interne, clinique vétérinaire de garde référencée, redirection vers un service 24h/24. Méfiez-vous des cabinets qui renvoient simplement vers le SAMU vétérinaire à 80 km sans aucun lien de continuité.",
      },
      { type: "h2", text: "3. Spécialités du vétérinaire" },
      {
        type: "p",
        text: "La médecine vétérinaire est aussi vaste que la médecine humaine. Certains praticiens sont généralistes excellents, d'autres ont développé une expertise : NAC (rongeurs, lapins, reptiles, oiseaux), ophtalmologie, cardiologie, dermatologie, comportement. Pour un animal exotique, choisissez d'emblée un cabinet équipé.",
      },
      { type: "h2", text: "4. Équipement et plateau technique" },
      {
        type: "p",
        text: "Demandez si la clinique dispose de la radiographie numérique, de l'échographie, d'un laboratoire d'analyses sur place, et d'un bloc chirurgical. Un cabinet bien équipé évite de transporter votre animal d'un site à l'autre et accélère le diagnostic.",
      },
      { type: "h2", text: "5. Tarifs et transparence" },
      {
        type: "p",
        text: "Une consultation classique coûte 35-60 € selon la région, une consultation spécialisée 60-90 €, une stérilisation chien 200-450 €, une stérilisation chat 70-150 €. Un bon véto remet un devis écrit avant toute intervention de plus de 100 €. La transparence sur les tarifs est un signal de confiance.",
      },
      { type: "h2", text: "6. Approche et écoute" },
      {
        type: "p",
        text: "Lors de la première consultation, observez : le praticien prend-il le temps d'examiner votre animal calmement ? Explique-t-il ses gestes ? Vous interroge-t-il sur l'alimentation, le mode de vie, le comportement ? Un véto qui expédie en 7 minutes une visite vaccinale vous rendra des diagnostics moins fiables sur la durée.",
      },
      { type: "h2", text: "7. Politique de stérilisation et de prévention" },
      {
        type: "p",
        text: "Un vétérinaire engagé propose un calendrier vaccinal clair, des campagnes de prévention (antiparasitaire, vermifuge), des conseils de nutrition adaptée à l'âge. Méfiez-vous à l'inverse de ceux qui multiplient les ventes d'aliments médicaux sans justification médicale.",
      },
      { type: "h2", text: "8. Avis et réputation" },
      {
        type: "p",
        text: "Lisez les avis Google et Facebook sur 1 à 2 ans : un cabinet régulièrement noté 4,5+ avec 50+ avis est un signal fiable. Les avis très négatifs portent souvent sur la facturation ou l'accueil — deux points qui rendent la relation impossible sur la durée. Demandez aussi à votre entourage et au voisinage.",
      },
      {
        type: "amazon",
        titre: "Bien équiper son foyer pour la santé de l'animal",
        produits: [
          { nom: "Caisse de transport chien chat", description: "Indispensable pour les visites véto sans stress et la sécurité en voiture.", recherche: "caisse transport chien chat" },
          { nom: "Thermomètre digital pour animaux", description: "Permet de prendre la température à la maison avant d'appeler le véto.", recherche: "thermometre digital animal chien chat" },
          { nom: "Trousse de premiers soins animal", description: "Compresses, désinfectant, pince à tique : le minimum à avoir chez soi.", recherche: "trousse premiers soins animal chien chat" },
          { nom: "Balance pour animaux jusqu'à 50 kg", description: "Surveiller le poids est l'un des meilleurs indicateurs de santé.", recherche: "balance animal chien chat" },
          { nom: "Pince à tique professionnelle", description: "Retirer une tique en sécurité, sans tête cassée, sans antiseptique.", recherche: "pince tique professionnelle" },
          { nom: "Coupe-griffes vétérinaire", description: "Entretien des griffes à la maison, recommandé entre 2 visites.", recherche: "coupe griffes chien chat veterinaire" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un vétérinaire près de chez vous",
        href: "/veterinaire",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Choisissez un vétérinaire à moins de 15 minutes, avec une procédure d'urgence claire, un plateau technique adapté à votre animal, des tarifs transparents et une écoute réelle. Lisez les avis sur la durée et faites confiance à votre ressenti à la première consultation : c'est la base d'un suivi de qualité sur 10 à 15 ans.",
      },
    ],
  },
  {
    slug: "toiletteur-chien-tarifs-frequence",
    title: "Toiletteur pour chien : tarifs, fréquence et critères de choix",
    description:
      "Combien coûte un toilettage chien en 2026 ? À quelle fréquence ? Comment choisir le bon toiletteur : notre guide complet.",
    metier: "toiletteur",
    date: "2026-05-20",
    readTime: 5,
    intro:
      "Brossage, bain, coupe, tonte : le toilettage n'est pas du luxe, c'est un acte d'hygiène. Mais entre les salons à 30 € et ceux à 90 €, la confusion est totale. Voici comment décrypter les tarifs et trouver un bon toiletteur.",
    sections: [
      { type: "h2", text: "Pourquoi le toilettage est important" },
      {
        type: "p",
        text: "Au-delà de l'esthétique, le toilettage permet de détecter tôt les anomalies (parasites, kystes, otites, plaies cutanées), de prévenir les nœuds qui tirent sur la peau, et de couper les griffes qui poussent vers les coussinets. Pour les races à poil long ou bouclé (caniche, bichon, shih tzu, cocker), c'est tout simplement indispensable.",
      },
      { type: "h2", text: "Les tarifs en 2026" },
      {
        type: "p",
        text: "Un toilettage complet (bain, séchage, brossage, coupe, oreilles, griffes, glandes anales) coûte 30-50 € pour un petit chien (jusqu'à 10 kg), 50-75 € pour un chien moyen, 75-110 € pour un grand chien. Les races à entretien lourd (caniche, bichon) sont au-dessus de la fourchette ; les races à poil court (labrador, beagle) en dessous. À Paris, ajoutez 15-25 %.",
      },
      { type: "h2", text: "À quelle fréquence ?" },
      {
        type: "ul",
        items: [
          "Poil court (labrador, boxer, bouledogue) : 1 fois tous les 3 mois suffit.",
          "Poil mi-long (golden retriever, berger australien) : toutes les 8 à 10 semaines.",
          "Poil long ou bouclé (caniche, bichon, shih tzu, cocker) : toutes les 4 à 6 semaines.",
          "Races à mue (husky, malinois) : 1 séance de carde tous les 2 mois en plus du toilettage classique.",
        ],
      },
      { type: "h2", text: "Toiletteur fixe ou itinérant ?" },
      {
        type: "p",
        text: "Le salon fixe reste le plus économique et offre généralement un meilleur équipement (table hydraulique, séchoir professionnel, douche surélevée). Le toiletteur itinérant (à domicile dans un camion équipé) coûte 15-25 € de plus, mais évite tout déplacement et tout stress du chien.",
      },
      { type: "h2", text: "Comment choisir un bon toiletteur" },
      {
        type: "p",
        text: "Demandez à visiter le salon avant la première séance : propre, calme, sans odeur d'urine. Un bon toiletteur prend 5 minutes pour discuter avec vous, sentir le chien, repérer les zones sensibles. Il refuse de toiletter un chien malade ou trop âgé sans accord du vétérinaire. Et il ne propose jamais de séance sous tranquillisant — ce serait illégal.",
      },
      { type: "h2", text: "Les signaux d'alerte" },
      {
        type: "ul",
        items: [
          "Rendu d'un chien stressé, baveux ou tremblant.",
          "Coupures, irritations ou plaies découvertes après la séance.",
          "Salon qui sent l'urine ou l'ammoniac.",
          "Refus de vous montrer la zone de séchage.",
          "Prix anormalement bas (en dessous de 25 €) — il y a forcément un compromis sur l'hygiène ou la durée.",
        ],
      },
      {
        type: "amazon",
        titre: "Entretenir entre 2 séances de toilettage",
        produits: [
          { nom: "Brosse rotative anti-nœuds", description: "Démêle sans tirer, idéal pour les races à poil long ou mi-long.", recherche: "brosse rotative anti noeuds chien" },
          { nom: "Carde pour mue", description: "Indispensable pour les races à double pelage (husky, golden, berger).", recherche: "carde chien mue undercoat" },
          { nom: "Shampoing chien sans paraben", description: "pH adapté à la peau du chien, sans irritation entre 2 toilettages.", recherche: "shampoing chien naturel sans paraben" },
          { nom: "Tondeuse silencieuse chien", description: "Pour les retouches autour des yeux, des coussinets et des oreilles.", recherche: "tondeuse silencieuse chien" },
          { nom: "Coupe-griffes anti-éclats", description: "Outil de qualité pour couper sans casser la griffe.", recherche: "coupe griffes chien securite" },
          { nom: "Lingettes nettoyantes pour oreilles", description: "Hygiène hebdomadaire pour éviter otites et infections.", recherche: "lingettes nettoyantes oreilles chien" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un toiletteur près de chez vous",
        href: "/toiletteur",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Comptez 30-110 € selon la taille, à raison de tous les 4-6 mois (poil court) à 4-6 semaines (poil long). Visitez le salon avant, observez l'hygiène et l'état du chien à la sortie. Entretenir entre les séances avec une bonne brosse divise la note finale par deux.",
      },
    ],
  },
  {
    slug: "prix-controle-technique-2026",
    title: "Prix d'un contrôle technique 2026 : tarifs, contre-visite, sanctions",
    description:
      "Combien coûte un contrôle technique en 2026 ? Quels sont les délais, les recours et les pièges à éviter. Le guide complet.",
    metier: "controle-technique",
    date: "2026-05-18",
    readTime: 5,
    intro:
      "Obligatoire dès 4 ans pour les voitures particulières, puis tous les 2 ans, le contrôle technique reste mal compris. Tarifs, délais, contre-visite, sanctions : voici tout ce qu'il faut savoir en 2026.",
    sections: [
      { type: "h2", text: "Tarif moyen d'un contrôle technique" },
      {
        type: "p",
        text: "En 2026, un contrôle technique pour véhicule essence ou diesel coûte 70 à 95 € selon la région et le centre. Les centres indépendants sont souvent 10-15 € moins chers que les grandes enseignes (Norauto, Dekra, Autosur), mais la qualité est identique : tous appliquent le même protocole homologué.",
      },
      {
        type: "p",
        text: "Pour les véhicules électriques, le contrôle est 5-10 € moins cher (pas de contrôle des émissions). Pour les véhicules à gaz (GPL, GNV), comptez 90-115 € : la vérification du circuit gaz est plus longue.",
      },
      { type: "h2", text: "La contre-visite : tarifs et obligations" },
      {
        type: "p",
        text: "Si votre voiture est refusée pour une défaillance majeure, vous avez 2 mois pour faire réparer et repasser une contre-visite. Celle-ci coûte 12-25 € (parfois gratuite chez certains centres si la contre-visite a lieu dans les 15 jours suivants). Une défaillance critique vous interdit de circuler sous 24h.",
      },
      { type: "h2", text: "Les 3 niveaux de défaillance" },
      {
        type: "ul",
        items: [
          "Mineure : à corriger, mais véhicule autorisé à circuler sans contre-visite.",
          "Majeure : contre-visite obligatoire sous 2 mois, circulation autorisée temporairement.",
          "Critique : véhicule autorisé à circuler seulement 24h (le temps de rentrer chez soi et de réparer).",
        ],
      },
      { type: "h2", text: "Les pannes les plus fréquentes au contrôle" },
      {
        type: "p",
        text: "Sur 100 voitures contrôlées en 2026, 19 sont refusées. Les défauts les plus fréquents sont : éclairage défectueux (35 %), pneumatiques usés (25 %), freinage (18 %), suspension (12 %), pollution (10 %). La plupart sont évitables avec un petit contrôle visuel avant de venir.",
      },
      { type: "h2", text: "Les sanctions en cas de non-respect" },
      {
        type: "p",
        text: "Circuler sans contrôle technique valide vous expose à une amende de 135 € (90 € minorée), une immobilisation du véhicule possible, et la non-prise en charge par l'assurance en cas d'accident grave. Le défaut de contrôle est l'un des motifs les plus fréquents de refus d'indemnisation.",
      },
      { type: "h2", text: "Les conseils pour ne pas se faire avoir" },
      {
        type: "ul",
        items: [
          "Vérifiez vous-même les ampoules avant de venir : un feu grillé peut coûter 12 € de contre-visite.",
          "Refaites le plein de liquide de freinage et de lave-glace : un niveau bas peut être noté.",
          "Si une réparation est nécessaire, demandez plusieurs devis : un centre de contrôle ne répare pas (interdiction légale), il vous oriente vers un garage indépendant.",
          "Refusez tout 'package' contrôle + diagnostic complémentaire payant : la diagnose moteur n'est pas obligatoire.",
        ],
      },
      {
        type: "amazon",
        titre: "Préparer sa voiture avant le contrôle",
        produits: [
          { nom: "Coffret d'ampoules de rechange voiture", description: "Toutes les ampoules H7, H4, P21W : un grillage est la cause n°1 de refus.", recherche: "coffret ampoules voiture rechange" },
          { nom: "Manomètre digital pression pneus", description: "Pression correcte avant le contrôle, plus de stress sur ce point.", recherche: "manometre digital pression pneus" },
          { nom: "Liquide de frein DOT 4", description: "Faire l'appoint avant le contrôle, niveau correct exigé.", recherche: "liquide frein DOT4" },
          { nom: "Lave-glace concentré 4 saisons", description: "Niveau de lave-glace vérifié au contrôle technique.", recherche: "lave glace concentre voiture" },
          { nom: "Kit éthylotest NF homologué", description: "Obligatoire dans le véhicule en cas de contrôle routier — pas vérifié en CT mais utile.", recherche: "ethylotest NF voiture" },
          { nom: "Triangle + gilet de sécurité", description: "Obligatoires à bord, vérifiés en cas de contrôle police.", recherche: "triangle gilet securite voiture" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un centre de contrôle technique",
        href: "/controle-technique",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Comptez 70-95 € en moyenne, 12-25 € de contre-visite. 19 % des voitures sont refusées, le plus souvent pour l'éclairage et les pneus — facilement vérifiables avant de venir. Circulez sans CT valide, c'est 135 € d'amende et un refus d'assurance en cas d'accident.",
      },
    ],
  },
  {
    slug: "garagiste-eviter-arnaques-reparation",
    title: "Garagiste : 7 arnaques fréquentes et comment les éviter",
    description:
      "Surfacturation, pièces inutiles, devis flou : les pièges courants chez le garagiste et les bons réflexes pour s'en prémunir.",
    metier: "garagiste",
    date: "2026-05-15",
    readTime: 6,
    intro:
      "Tous les garagistes ne sont pas malhonnêtes — loin de là. Mais quelques pratiques douteuses existent, et un client mal informé est une cible facile. Voici les 7 arnaques les plus courantes et comment les détecter avant qu'elles ne vous coûtent cher.",
    sections: [
      { type: "h2", text: "1. Le devis sans signature préalable" },
      {
        type: "p",
        text: "Toute réparation au-delà de 50 € exige un devis écrit signé. Si un garagiste démarre l'intervention 'on verra à la fin combien ça fait', vous êtes en zone à risque. Demandez systématiquement le devis avant tout démontage. Si le diagnostic révèle d'autres pannes, un avenant écrit doit être signé.",
      },
      { type: "h2", text: "2. La pièce 'd'origine' qui n'en est pas une" },
      {
        type: "p",
        text: "Une pièce d'origine constructeur coûte 30 à 50 % plus cher qu'une pièce adaptable (équipementier comme Bosch, Valeo, Sachs). Certains garagistes facturent au prix de l'origine en montant une adaptable. Demandez systématiquement la facture du fournisseur ou la pièce remplacée pour vérifier la marque.",
      },
      { type: "h2", text: "3. L'ajout de pannes 'découvertes'" },
      {
        type: "p",
        text: "Vous venez pour un vidange, on vous appelle pour vous annoncer 4 pannes supplémentaires à 800 €. Possible — mais à vérifier. Demandez à voir les pièces défectueuses, photo à l'appui. Si le garagiste refuse, c'est un signal d'alerte sérieux.",
      },
      { type: "h2", text: "4. La main d'œuvre gonflée" },
      {
        type: "p",
        text: "Chaque réparation a un barème de temps homologué (publié par les constructeurs et accessible aux indépendants). Un changement de plaquettes de frein = 1h, pas 2h30. Si le temps facturé semble disproportionné, demandez la justification écrite.",
      },
      { type: "h2", text: "5. Le 'forfait' qui cache plus qu'il ne montre" },
      {
        type: "p",
        text: "Le forfait révision à 199 € est attractif, mais peut exclure la vidange, le filtre à habitacle, le contrôle des freins. Lisez attentivement la liste précise des opérations incluses. Un bon forfait détaille point par point ce qui est fait.",
      },
      { type: "h2", text: "6. Le diagnostic électronique facturé après devis refusé" },
      {
        type: "p",
        text: "Si vous refusez le devis après diagnostic, le garagiste peut facturer 30-80 € pour la prise en charge. Légal — à condition qu'il vous l'ait annoncé à l'entrée. Si vous découvrez la facture sans avoir été prévenu, contestez-la et demandez l'écrit préalable.",
      },
      { type: "h2", text: "7. La retenue du véhicule" },
      {
        type: "p",
        text: "Un garagiste peut légalement garder votre voiture tant que vous n'avez pas payé. Mais il ne peut pas vous facturer un 'stationnement' au-delà de 24h après la fin des travaux. Si vous contestez la facture, payez la partie non contestée et contestez le reste par lettre recommandée.",
      },
      { type: "h2", text: "Les bons réflexes" },
      {
        type: "ul",
        items: [
          "Demandez 2 ou 3 devis pour toute réparation au-dessus de 300 €.",
          "Vérifiez si le garagiste est agréé constructeur ou indépendant (souvent moins cher pour qualité équivalente).",
          "Conservez les pièces remplacées — c'est un droit légal.",
          "Lisez les avis Google sur la durée, pas seulement les derniers.",
          "Pour un problème complexe, demandez un second avis ailleurs avant d'autoriser une grosse réparation.",
        ],
      },
      {
        type: "amazon",
        titre: "S'équiper pour limiter les passages garage",
        produits: [
          { nom: "Boîtier diagnostic OBD2 Bluetooth", description: "Lire vous-même les codes défaut moteur avant d'aller au garage.", recherche: "boitier diagnostic OBD2 bluetooth" },
          { nom: "Cric hydraulique voiture", description: "Pour les petites interventions à domicile en toute sécurité.", recherche: "cric hydraulique voiture" },
          { nom: "Clés à choc 1/2 pouce", description: "Démontage de roues et travaux de freinage simples.", recherche: "cle a choc voiture 1/2 pouce" },
          { nom: "Mallette d'outils mécanicien", description: "Set complet : pinces, clés, tournevis spécifiques auto.", recherche: "mallette outils mecanicien voiture" },
          { nom: "Filtres habitacle universels", description: "Remplacement annuel à faire soi-même, 20 € au lieu de 60 € au garage.", recherche: "filtre habitacle voiture" },
          { nom: "Multimètre auto électricien", description: "Tester batterie, alternateur, fusibles avant d'aller au garage.", recherche: "multimetre auto" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un garagiste fiable près de chez vous",
        href: "/garagiste",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Devis écrit signé avant intervention, deux ou trois devis pour les grosses réparations, photo des pièces défectueuses, conservation des pièces remplacées. Ces quatre réflexes éliminent 80 % du risque d'arnaque chez le garagiste.",
      },
    ],
  },
  {
    slug: "comportementaliste-animalier-utilite-tarifs",
    title: "Comportementaliste animalier : à quoi ça sert vraiment et combien ça coûte",
    description:
      "Aboiements, agressivité, malpropreté, anxiété de séparation : quand consulter un comportementaliste pour son chien ou son chat, et combien ça coûte.",
    metier: "comportementaliste",
    date: "2026-05-12",
    readTime: 6,
    intro:
      "Votre chien aboie toute la journée dès qu'il reste seul, votre chat urine partout sauf dans sa litière, votre chiot mord tout ce qui bouge ? Un comportementaliste animalier peut transformer la situation. Voici ce qu'il fait, à quel prix, et comment le choisir.",
    sections: [
      { type: "h2", text: "Comportementaliste, éducateur, dresseur : la différence" },
      {
        type: "p",
        text: "L'éducateur canin apprend les ordres de base (assis, couché, rappel) à un chiot ou un jeune adulte. Le dresseur prépare l'animal à une compétence précise (chasse, sauvetage, agility). Le comportementaliste, lui, traite les troubles du comportement chez l'adulte : agressivité, anxiété, phobies, malpropreté, destructions, aboiements compulsifs.",
      },
      { type: "h2", text: "Quand consulter" },
      {
        type: "ul",
        items: [
          "Anxiété de séparation : aboiements continus, destructions dès que vous partez.",
          "Agressivité envers les humains ou autres animaux, sans déclencheur clair.",
          "Malpropreté soudaine chez un animal jusque-là propre.",
          "Peurs invalidantes (orages, voitures, déplacements).",
          "Comportements compulsifs : pourchasser sa queue, lécher une zone jusqu'à la blessure.",
        ],
      },
      { type: "h2", text: "Tarifs en 2026" },
      {
        type: "p",
        text: "Une première consultation comportementaliste dure 1h30 à 2h et coûte 90 à 150 €. Elle inclut un bilan complet : observation de l'animal, interrogatoire des propriétaires sur l'environnement, l'alimentation, le rythme de vie, l'histoire. Les séances suivantes (45-60 min) coûtent 60 à 90 €. Un suivi complet représente 3 à 6 séances, soit 300 à 700 €.",
      },
      { type: "h2", text: "Le bilan, étape clé" },
      {
        type: "p",
        text: "Avant tout protocole, le comportementaliste vérifie qu'aucune cause médicale n'est en jeu : douleur cachée, hypothyroïdie chez le chien, hyperthyroïdie chez le chat, problème urinaire. Il travaille en lien avec votre vétérinaire et n'hésite pas à le faire intervenir si un examen complémentaire est nécessaire.",
      },
      { type: "h2", text: "Méthodes : ce que vous devriez voir" },
      {
        type: "p",
        text: "Un bon comportementaliste utilise des méthodes positives : récompense, renforcement des bons comportements, désensibilisation progressive. Fuyez tout praticien qui propose des colliers étrangleurs, électriques ou des méthodes 'd'affirmation par la peur'. Ces approches sont à la fois inefficaces sur la durée et déontologiquement inacceptables.",
      },
      { type: "h2", text: "Formation et qualifications" },
      {
        type: "p",
        text: "Le titre de comportementaliste n'est pas protégé en France. Vérifiez la formation initiale : ESC (École Supérieure du Comportement), Vox Animae, ou diplôme universitaire d'éthologie. Une expérience de 3 ans minimum et un suivi de formation continue sont des signaux de qualité. Demandez les certifications.",
      },
      { type: "h2", text: "Domicile ou cabinet ?" },
      {
        type: "p",
        text: "Pour un trouble du comportement à la maison (malpropreté, destructions, anxiété de séparation), une consultation à domicile est indispensable : le comportementaliste doit voir l'environnement réel. Pour de l'agressivité ciblée, le cabinet permet un cadre neutre et plus sécurisé.",
      },
      {
        type: "amazon",
        titre: "Accompagner le travail du comportementaliste",
        produits: [
          { nom: "Diffuseur Feliway chat / Adaptil chien", description: "Phéromones apaisantes recommandées par les comportementalistes pour anxiété.", recherche: "diffuseur feliway adaptil pheromones" },
          { nom: "Jouet distributeur de croquettes Kong", description: "Stimulation mentale en cas d'ennui ou anxiété de séparation.", recherche: "jouet kong distributeur croquettes" },
          { nom: "Tapis de léchage anti-stress", description: "Calme l'animal anxieux, idéal avant le départ du propriétaire.", recherche: "tapis lechage anti stress chien chat" },
          { nom: "Clicker éducation animal", description: "Outil de renforcement positif utilisé par les comportementalistes.", recherche: "clicker education chien chat" },
          { nom: "Harnais anti-traction chien", description: "Pour les promenades plus calmes pendant le travail comportemental.", recherche: "harnais anti traction chien" },
          { nom: "Arbre à chat haut avec cachettes", description: "Réduit le stress du chat en lui offrant un territoire vertical sécurisé.", recherche: "arbre a chat grand avec cachettes" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un comportementaliste animalier",
        href: "/comportementaliste",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Comptez 90-150 € pour le bilan initial, 60-90 € par séance de suivi. Un protocole complet sur 3-6 séances vaut 300-700 € et règle durablement la grande majorité des cas. Choisissez un praticien formé (ESC, Vox Animae), qui travaille avec votre vétérinaire et utilise uniquement des méthodes positives.",
      },
    ],
  },
  {
    slug: "barbier-vs-coiffeur-homme-choisir",
    title: "Barbier ou coiffeur homme : que choisir et à quel prix",
    description:
      "Coupe, barbe, rasage : les vraies différences entre barbier et coiffeur homme, leurs tarifs et leurs spécialités.",
    metier: "barbier",
    date: "2026-05-10",
    readTime: 5,
    intro:
      "Tous deux coupent les cheveux des hommes — mais l'un et l'autre ne font pas exactement le même métier. Barbier ou coiffeur : voici comment choisir selon ce que vous recherchez, et combien ça coûte en 2026.",
    sections: [
      { type: "h2", text: "La différence fondamentale" },
      {
        type: "p",
        text: "Le coiffeur est formé à la coupe de cheveux pour tous (hommes, femmes, enfants). Le barbier est un spécialiste exclusivement masculin, expert en barbe, rasage traditionnel à la lame, et coupes hommes structurées. Un barbier sait toujours couper les cheveux ; un coiffeur ne sait pas toujours tailler une barbe au cordeau.",
      },
      { type: "h2", text: "Quand aller chez le coiffeur homme" },
      {
        type: "ul",
        items: [
          "Coupe classique cheveux courts ou mi-longs sans barbe.",
          "Coupe famille en même temps que femme/enfant.",
          "Coloration ou traitement chimique du cheveu.",
          "Budget serré ou recherche d'un service rapide.",
          "Quartier sans barbershop spécialisé à proximité.",
        ],
      },
      { type: "h2", text: "Quand aller chez le barbier" },
      {
        type: "ul",
        items: [
          "Barbe à tailler, structurer ou raser entièrement à la lame.",
          "Coupe homme moderne : fade, dégradé américain, undercut, side parting.",
          "Recherche d'un service haut de gamme avec rituel (serviette chaude, mousse à raser, baume après-rasage).",
          "Cheveux frisés ou crépus : les barbiers sont souvent mieux formés sur ces textures.",
          "Préparation événement (mariage, photo professionnelle).",
        ],
      },
      { type: "h2", text: "Les tarifs en 2026" },
      {
        type: "p",
        text: "Coupe homme classique chez un coiffeur : 18-32 €. Coupe homme chez un barbier : 25-45 €. Taille de barbe seule chez un barbier : 15-25 €. Rasage traditionnel à la lame : 25-40 €. Forfait coupe + barbe : 40-65 €. À Paris, les tarifs barbiers haut de gamme peuvent monter à 70-90 € pour un forfait complet.",
      },
      { type: "h2", text: "Le rasage à la lame : un savoir-faire" },
      {
        type: "p",
        text: "Le rasage traditionnel au coupe-chou n'est pas du folklore. Bien exécuté, il offre un rasage plus précis qu'aucun rasoir électrique, sans irritation, avec un rituel qui détend (serviette chaude, mousse appliquée au blaireau, baume après-rasage). Mais c'est un savoir-faire : seuls les barbiers formés à la dague (école Razzia, MBBS, ou compagnonnage) garantissent un service sans risque.",
      },
      { type: "h2", text: "Comment reconnaître un bon barbershop" },
      {
        type: "ul",
        items: [
          "Diplôme ou attestation de formation barbier visible.",
          "Lame jetable systématiquement changée entre chaque client.",
          "Désinfection des outils à vue (autoclave ou solution Barbicide).",
          "Conseils sur l'entretien à la maison (huile à barbe, peigne, brosse).",
          "Pas de précipitation : une coupe + barbe demande 45 min minimum.",
        ],
      },
      {
        type: "amazon",
        titre: "Entretenir sa coupe et sa barbe entre 2 visites",
        produits: [
          { nom: "Huile à barbe nourrissante", description: "Hydrate la barbe, calme les démangeaisons, parfum discret.", recherche: "huile barbe nourrissante homme" },
          { nom: "Tondeuse barbe et cheveux professionnelle", description: "Pour les retouches entre les visites au barbier.", recherche: "tondeuse barbe cheveux professionnelle" },
          { nom: "Peigne en bois pour barbe", description: "Démêle sans casser le poil, évite l'électricité statique.", recherche: "peigne bois barbe homme" },
          { nom: "Blaireau et mousse à raser traditionnel", description: "Pour les amateurs de rasage à l'ancienne à domicile.", recherche: "blaireau mousse a raser traditionnel" },
          { nom: "Baume après-rasage apaisant", description: "Calme la peau irritée après le rasage, hydrate en profondeur.", recherche: "baume apres rasage homme apaisant" },
          { nom: "Ciseaux de coupe barbe précision", description: "Retoucher la moustache et les angles entre les visites.", recherche: "ciseaux coupe barbe precision" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un barbier près de chez vous",
        href: "/barbier",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Coiffeur pour la coupe rapide et économique ; barbier pour la barbe travaillée, les coupes modernes type fade, et le rituel rasage à la lame. Comptez 18-32 € chez le coiffeur, 25-45 € pour une coupe au barbier, 40-65 € pour un forfait coupe + barbe.",
      },
    ],
  },
  {
    slug: "carreleur-prix-pose-m2-2026",
    title: "Prix de pose carrelage au m² en 2026 : tarifs et conseils",
    description:
      "Pose carrelage sol, mur, salle de bain, terrasse : tarifs détaillés au m² pour 2026 et critères pour bien choisir son carreleur.",
    metier: "carreleur",
    date: "2026-05-08",
    readTime: 6,
    intro:
      "Le coût d'une pose de carrelage varie de 25 € à 110 € le m² selon le type de pose, le carreau et la difficulté du chantier. Voici le détail des tarifs en 2026 et les bons réflexes pour ne pas se faire surprendre.",
    sections: [
      { type: "h2", text: "Tarif moyen de pose au m²" },
      {
        type: "p",
        text: "En 2026, la pose seule (hors fourniture du carrelage) coûte 30-60 € le m² pour un carrelage standard 30x60 cm, 45-80 € pour du grand format (60x60 ou plus), 60-110 € pour de la mosaïque ou des motifs complexes. La fourniture du carrelage représente 15-80 € le m² supplémentaire selon la qualité.",
      },
      { type: "h2", text: "Pose droite, en diagonale, en chevrons" },
      {
        type: "ul",
        items: [
          "Pose droite (alignée) : tarif de base, soit 30-50 € le m² de main d'œuvre.",
          "Pose en quinconce ou décalée : +5 à 10 € le m².",
          "Pose en diagonale : +10 à 20 € le m² (plus de chutes, plus de découpes).",
          "Pose à chevrons ou bâtons rompus : +20 à 35 € le m².",
          "Pose en mosaïque : 60-110 € le m² selon la finesse.",
        ],
      },
      { type: "h2", text: "Tarifs selon les pièces" },
      {
        type: "p",
        text: "Salle de bain : la pose mur + sol coûte 50-80 € le m² pour le sol et 60-90 € le m² pour les murs (plus de découpes autour de la baignoire, du lavabo, des angles). Cuisine : 40-65 € le m² pour le sol, 50-75 € le m² pour la crédence. Terrasse extérieure : 35-55 € le m² avec préparation du support. Pièces de vie (séjour, chambre) : 30-50 € le m².",
      },
      { type: "h2", text: "Les frais annexes à anticiper" },
      {
        type: "ul",
        items: [
          "Dépose de l'ancien carrelage : 10-25 € le m².",
          "Ragréage de la chape pour planéité : 15-30 € le m².",
          "Étanchéité de salle de bain (SPEC) : 20-40 € le m².",
          "Joints colorés ou époxy : +5 à 15 € le m².",
          "Profilés et plinthes : 8-15 € le mètre linéaire.",
        ],
      },
      { type: "h2", text: "Comment choisir un bon carreleur" },
      {
        type: "p",
        text: "Demandez au moins 3 devis détaillés. Un carreleur fiable visite le chantier avant de chiffrer, mesure les surfaces, identifie les pièges (planéité, étanchéité existante, ventilation). Il indique précisément la marque et le format du carrelage prévu, le type de colle et de joint utilisés, et propose une garantie décennale.",
      },
      { type: "h2", text: "Les signaux d'alerte" },
      {
        type: "ul",
        items: [
          "Devis sans déplacement préalable : pas de mesure, pas de vérification.",
          "Tarif anormalement bas (sous 20 € le m² de pose) : qualité ou main d'œuvre non déclarée.",
          "Pas d'assurance décennale fournie au devis : illégal pour ce type de travaux.",
          "Acompte demandé supérieur à 30 % : signal d'alerte fort.",
          "Refus de fournir le numéro SIRET ou la qualification professionnelle.",
        ],
      },
      {
        type: "amazon",
        titre: "Préparer son chantier carrelage soi-même",
        produits: [
          { nom: "Niveau laser autonivelant", description: "Vérifier la planéité du support avant pose, indispensable.", recherche: "niveau laser autonivelant" },
          { nom: "Coupe-carrelage manuel grand format", description: "Découpes droites précises sans poussière.", recherche: "coupe carrelage manuel grand format" },
          { nom: "Truelle à colle crantée", description: "Application régulière de la colle au sol et au mur.", recherche: "truelle crantee colle carrelage" },
          { nom: "Croisillons de carrelage", description: "Joints réguliers garantis, indispensables pour un rendu pro.", recherche: "croisillons carrelage" },
          { nom: "Spatule à joints en caoutchouc", description: "Pose et lissage des joints sans rayer le carreau.", recherche: "spatule joints carrelage caoutchouc" },
          { nom: "Genouillères de chantier", description: "Indispensables si vous posez du sol sur plusieurs heures.", recherche: "genouilleres chantier carreleur" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un carreleur près de chez vous",
        href: "/carreleur",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Comptez 30-60 € le m² pour une pose droite standard, +10 à 35 € pour des poses complexes (diagonale, chevrons). Ajoutez la dépose (10-25 €/m²), le ragréage (15-30 €/m²) et l'étanchéité en salle de bain (20-40 €/m²). Trois devis sur visite obligatoire, garantie décennale exigée.",
      },
    ],
  },
  {
    slug: "pet-sitter-tarifs-comment-choisir",
    title: "Pet-sitter : tarifs 2026 et comment choisir la bonne personne",
    description:
      "Confier son animal pendant les vacances : tarifs pet-sitter à domicile ou en garde, et les critères pour faire le bon choix.",
    metier: "pet-sitter",
    date: "2026-05-05",
    readTime: 5,
    intro:
      "Pour de nombreux propriétaires, les vacances posent un casse-tête : que faire de Loulou ou Felix pendant 10 jours ? Le pet-sitter est la solution la plus douce pour l'animal. Voici les tarifs, les formules et les bons réflexes.",
    sections: [
      { type: "h2", text: "Les 3 formules principales" },
      {
        type: "ul",
        items: [
          "Visites à domicile : le pet-sitter passe 1 à 3 fois par jour chez vous pour nourrir, sortir, câliner.",
          "Garde à domicile du sitter : votre animal vit chez le pet-sitter pendant votre absence.",
          "Garde permanente : le pet-sitter s'installe chez vous (idéal pour chiens anxieux et plusieurs animaux).",
        ],
      },
      { type: "h2", text: "Les tarifs en 2026" },
      {
        type: "p",
        text: "Visite à domicile (30 min) : 12-20 € la visite. Visite longue (1h avec sortie chien) : 18-28 €. Garde chez le pet-sitter : 18-35 € par jour pour un chat, 25-50 € par jour pour un chien. Garde permanente chez vous (24h/24) : 35-70 € par jour. À Paris et grandes villes, ajoutez 20-30 %.",
      },
      { type: "h2", text: "Les frais annexes" },
      {
        type: "ul",
        items: [
          "Animal supplémentaire : +25 à 50 % sur le tarif de base.",
          "Visite supplémentaire le jour (sortie ou jeu) : 10-15 €.",
          "Médicaments à administrer : généralement inclus dans les tarifs standards.",
          "Jours fériés et fêtes : majoration de 25 à 50 %.",
          "Frais de déplacement si vous êtes loin du sitter : 0,30-0,60 € le km au-delà de 10 km.",
        ],
      },
      { type: "h2", text: "Plateforme ou pet-sitter indépendant ?" },
      {
        type: "p",
        text: "Les plateformes (Animaute, Holidog, Pawshake, Yoopies, MyMaster) facturent une commission de 10-25 % mais sécurisent la transaction et incluent souvent une assurance responsabilité civile. Un pet-sitter indépendant connu par bouche-à-oreille est moins cher mais demande plus de vigilance sur les références.",
      },
      { type: "h2", text: "Les 7 critères pour bien choisir" },
      {
        type: "ol",
        items: [
          "Rencontre obligatoire avant le séjour : observez comment l'animal réagit.",
          "Demandez 2 à 3 références d'anciens clients.",
          "Vérifiez l'assurance responsabilité civile professionnelle.",
          "Demandez une expérience avec votre espèce (un chat n'est pas un chien).",
          "Visitez le lieu de garde si l'animal va chez le sitter.",
          "Convenez d'un protocole écrit : alimentation, médicaments, contacts d'urgence, vétérinaire référent.",
          "Demandez des nouvelles régulières (photo, message quotidien).",
        ],
      },
      { type: "h2", text: "Les signaux d'alerte" },
      {
        type: "p",
        text: "Fuyez les pet-sitters qui acceptent de prendre votre animal sans rencontre préalable, qui refusent de visiter votre domicile ou de vous montrer le leur, qui n'ont aucune référence à fournir, ou qui demandent un paiement intégral en espèces sans facture. La pet-sitting est aujourd'hui un vrai métier avec des standards : ne descendez pas en dessous.",
      },
      {
        type: "amazon",
        titre: "Préparer son animal pour une absence",
        produits: [
          { nom: "Caméra connectée pour animal", description: "Surveiller et parler à son animal à distance, beaucoup de modèles à moins de 50 €.", recherche: "camera connectee chien chat" },
          { nom: "Distributeur automatique de croquettes", description: "Sécurise les repas si le sitter ne peut pas être présent à l'heure pile.", recherche: "distributeur automatique croquettes" },
          { nom: "Fontaine à eau pour chat / chien", description: "Garantit l'hydratation permanente pendant l'absence.", recherche: "fontaine eau chat chien" },
          { nom: "Tracker GPS pour chien Tractive", description: "Suivre les promenades du chien en temps réel pendant la garde.", recherche: "tracker GPS chien tractive" },
          { nom: "Litière auto-nettoyante chat", description: "Limite les passages du sitter, hygiène impeccable.", recherche: "litiere automatique chat" },
          { nom: "Cage de transport solide", description: "Indispensable si le sitter doit gérer une urgence vétérinaire.", recherche: "cage transport chien chat solide" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un pet-sitter près de chez vous",
        href: "/pet-sitter",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Visite à domicile 12-28 €, garde chez le sitter 18-50 €/jour, garde permanente 35-70 €/jour. Rencontre préalable obligatoire, références exigées, assurance vérifiée, protocole écrit. Une caméra connectée à 40 € apporte un confort considérable pendant l'absence.",
      },
    ],
  },
  {
    slug: "coiffeur-domicile-tarifs-avantages",
    title: "Coiffeur à domicile : tarifs et avantages en 2026",
    description:
      "Combien coûte un coiffeur à domicile ? Pour qui c'est intéressant et comment choisir un bon professionnel itinérant.",
    metier: "coiffeur",
    date: "2026-05-02",
    readTime: 5,
    intro:
      "Plus de salon d'attente, pas de déplacement, le coiffeur vient à vous. La coiffure à domicile séduit de plus en plus, surtout depuis 2020. Voici les tarifs réels en 2026 et les bons réflexes pour bien choisir.",
    sections: [
      { type: "h2", text: "Le tarif moyen" },
      {
        type: "p",
        text: "Une coupe homme à domicile coûte 25-40 €, une coupe femme 35-65 €, un brushing seul 25-40 €, une coloration complète 70-130 €, un balayage 90-180 €. Comptez 10-20 € de plus qu'en salon en moyenne — cette différence rémunère le déplacement et l'organisation du matériel. À Paris et grandes villes, ajoutez 15-25 %.",
      },
      { type: "h2", text: "Pour qui c'est rentable" },
      {
        type: "ul",
        items: [
          "Personnes âgées ou à mobilité réduite : aucun déplacement.",
          "Jeunes mamans avec un nouveau-né : pas de baby-sitter à organiser.",
          "Mariages, événements : coiffure des invitées sur le lieu de réception.",
          "Travailleurs aux horaires atypiques : créneaux soir et week-end.",
          "Familles : plusieurs membres coiffés à la suite, économie de temps.",
        ],
      },
      { type: "h2", text: "Salarié, indépendant ou plateforme ?" },
      {
        type: "p",
        text: "Un coiffeur indépendant à domicile est moins cher mais demande plus de vigilance sur les qualifications. Les plateformes (Wecasa, Popmycar, Stootie) sécurisent la transaction, vérifient les CAP/BP, et incluent souvent une garantie satisfait/remboursé. Compter 10-15 € de plus chez les plateformes.",
      },
      { type: "h2", text: "Les services techniques à domicile" },
      {
        type: "p",
        text: "Coupe, brushing et coloration simples sont parfaitement réalisables à domicile. Le balayage complexe demande un éclairage et un point d'eau adaptés ; certains coiffeurs préfèrent réaliser cette étape en salon partenaire. Le lissage brésilien et les permanentes longues exigent une ventilation adaptée et sont rarement proposés à domicile.",
      },
      { type: "h2", text: "Ce qu'il faut préparer chez soi" },
      {
        type: "ul",
        items: [
          "Une chaise confortable près d'un point d'eau (lavabo ou évier).",
          "Une serviette propre et un peignoir si possible.",
          "Un sol facile à nettoyer (carrelage ou linoléum).",
          "Un bon éclairage : lumière du jour idéale, sinon lampes blanches.",
          "Une prise électrique accessible (sèche-cheveux, lisseur).",
        ],
      },
      { type: "h2", text: "Bien choisir son coiffeur à domicile" },
      {
        type: "p",
        text: "Vérifiez la qualification (CAP minimum, BP recommandé), demandez des photos de réalisations récentes (Instagram fournit souvent un bon aperçu). Une rencontre courte avant la première prestation permet d'ajuster les attentes. Pour une coloration, demandez une mèche test 48h avant si vous avez la peau sensible.",
      },
      {
        type: "amazon",
        titre: "Bien s'organiser pour une coiffure à domicile",
        produits: [
          { nom: "Peignoir de coiffure professionnel", description: "Évite les chutes de cheveux sur les vêtements, lavable.", recherche: "peignoir coiffure professionnel" },
          { nom: "Cape de coupe imperméable", description: "Cape à fixation pratique pour protéger ses vêtements.", recherche: "cape coupe coiffure" },
          { nom: "Aspirateur à main pour cheveux", description: "Nettoyage rapide après la séance, sans réveiller le bébé.", recherche: "aspirateur main puissant" },
          { nom: "Miroir mural double face grossissant", description: "Pour vérifier la coupe sous tous les angles à la maison.", recherche: "miroir mural double face grossissant" },
          { nom: "Sèche-cheveux ionique professionnel", description: "Si vous prévoyez d'enchaîner plusieurs séchages dans la famille.", recherche: "seche cheveux ionique professionnel" },
          { nom: "Brosse brushing ronde céramique", description: "Pour entretenir la coupe et le volume entre 2 visites.", recherche: "brosse brushing ronde ceramique" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un coiffeur à domicile",
        href: "/coiffeur",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Coupe homme 25-40 €, coupe femme 35-65 €, coloration 70-130 €. 10-20 € de plus qu'en salon, mais zéro déplacement et un service personnalisé. Pour les mobilités réduites, les jeunes parents et les mariages, c'est imbattable. Vérifiez la qualification et préparez une chaise + un point d'eau.",
      },
    ],
  },
  {
    slug: "carrossier-prix-reparation-2026",
    title: "Carrossier : prix réparation carrosserie en 2026",
    description:
      "Bosse, rayure, choc, peinture complète : combien coûte une réparation chez le carrossier et comment éviter les surfacturations.",
    metier: "carrossier",
    date: "2026-04-28",
    readTime: 6,
    intro:
      "Un coup de portière sur le parking, une rayure profonde, un accrochage : le passage chez le carrossier devient inévitable. Voici les tarifs réels en 2026 et comment bien gérer un dossier carrosserie sans surcoût.",
    sections: [
      { type: "h2", text: "Réparations courantes : les tarifs" },
      {
        type: "ul",
        items: [
          "Petite bosse sans peinture (débosselage sans peinture, technique DSP) : 80-180 €.",
          "Rayure superficielle (polissage et lustrage) : 50-130 €.",
          "Rayure profonde (avec retouche peinture) : 150-350 € selon la zone.",
          "Aile cabossée à débosseler et repeindre : 300-650 €.",
          "Portière à remplacer et repeindre : 600-1200 €.",
          "Pare-chocs à remplacer et repeindre : 450-900 €.",
          "Peinture complète véhicule : 2500-6000 € selon qualité et préparation.",
        ],
      },
      { type: "h2", text: "DSP : la technique du débosselage sans peinture" },
      {
        type: "p",
        text: "Le débosselage sans peinture (DSP, paintless dent repair) permet de remettre en forme une tôle à l'aide d'outils spécifiques, sans casser la peinture d'origine. Cette technique est idéale pour les chocs de grêle, les coups de portière et les petites bosses. Tarif : 80-180 € selon la taille — bien moins cher qu'une réparation classique.",
      },
      { type: "h2", text: "Carrosserie et assurance" },
      {
        type: "p",
        text: "Pour un sinistre matériel responsable, votre franchise s'applique (200-600 € en général). Pour un sinistre non responsable identifié (avec constat amiable), aucune avance de frais n'est nécessaire dans le cadre du protocole IRSA : le carrossier facture directement votre assureur. Demandez un carrossier agréé par votre assurance pour faciliter le dossier.",
      },
      { type: "h2", text: "Pièces neuves, occasion, adaptables : la grosse différence" },
      {
        type: "p",
        text: "Une pièce neuve d'origine constructeur coûte le prix fort. Une pièce d'origine équipementier (Bosch, Valeo, Mahle, Plastic Omnium) est 30-50 % moins chère pour une qualité identique. Une pièce d'occasion (centre VHU ou casse) coûte 40-70 % moins cher mais demande vigilance sur l'état réel. Demandez systématiquement la précision sur le devis.",
      },
      { type: "h2", text: "Le devis : ce qu'il doit contenir" },
      {
        type: "ul",
        items: [
          "Description précise de chaque pièce remplacée ou réparée.",
          "Type de pièce (neuve origine, équipementier, occasion) pour chaque référence.",
          "Heures de main d'œuvre détaillées par poste.",
          "Coût peinture (préparation, apprêt, base, vernis).",
          "Garantie sur les travaux (minimum 1 an, souvent 2 ans en carrosserie).",
        ],
      },
      { type: "h2", text: "Les pièges à éviter" },
      {
        type: "p",
        text: "Méfiez-vous des estimations 'par téléphone' sans voir le véhicule : la moindre déformation cachée change tout. Refusez les forfaits 'tout compris' qui ne détaillent pas les pièces. Et ne signez jamais une cession à l'assurance avant d'avoir reçu le devis détaillé : vous perdez tout pouvoir de négociation.",
      },
      { type: "h2", text: "Comment choisir un bon carrossier" },
      {
        type: "p",
        text: "Cherchez un carrossier agréé par votre assurance (ils sont contrôlés sur la qualité). Demandez des photos de réalisations sur des véhicules similaires au vôtre. Un bon professionnel propose une cabine de peinture chauffée pour un séchage uniforme. Et il fournit une facture détaillée mentionnant SIRET, garantie, et caractéristiques exactes des pièces utilisées.",
      },
      {
        type: "amazon",
        titre: "Petites réparations à faire soi-même",
        produits: [
          { nom: "Stylo retouche peinture voiture", description: "Pour les rayures superficielles, code couleur constructeur exigé.", recherche: "stylo retouche peinture voiture" },
          { nom: "Kit débosselage ventouse", description: "Pour les petites bosses lisses, fonctionne sur tôles non pliées.", recherche: "kit debosselage ventouse voiture" },
          { nom: "Polish anti-rayures voiture", description: "Effacer les micro-rayures à la main, plusieurs marques efficaces.", recherche: "polish anti rayures voiture" },
          { nom: "Cire de finition voiture", description: "Protéger la peinture après réparation et donner un effet miroir.", recherche: "cire finition voiture" },
          { nom: "Microfibres polish voiture", description: "Indispensables pour appliquer polish et cire sans rayer.", recherche: "microfibres polish voiture" },
          { nom: "Code couleur peinture constructeur", description: "Trouver le code exact pour commander une retouche conforme.", recherche: "guide code couleur peinture voiture" },
        ],
      },
      {
        type: "cta",
        text: "Trouver un carrossier près de chez vous",
        href: "/carrossier",
      },
      { type: "h2", text: "À retenir" },
      {
        type: "p",
        text: "Petits chocs : 80-180 € en DSP. Rayures profondes : 150-350 €. Aile complète : 300-650 €. Portière : 600-1200 €. Demandez 3 devis détaillés, privilégiez un carrossier agréé par votre assurance, vérifiez le type de pièces (origine, équipementier, occasion). La franchise et le protocole IRSA changent tout sur la facture finale.",
      },
    ],
  },
  {
    slug: "deboucher-wc-sans-plombier",
    title: "Déboucher des WC bouchés sans plombier : la méthode qui marche",
    description: "WC bouchés ? Avant d'appeler un plombier (80-150 €), essayez ces méthodes simples : ventouse, furet, eau chaude. Le bon matériel et les bons gestes.",
    metier: "plombier",
    date: "2026-06-05",
    readTime: 6,
    intro:
      "Des toilettes bouchées, c'est l'urgence domestique par excellence — et la bonne nouvelle, c'est qu'on s'en sort presque toujours seul, sans plombier ni produit corrosif. Dans 9 cas sur 10, une ventouse adaptée ou un furet suffisent. Voici les méthodes dans le bon ordre, de la plus douce à la plus efficace.",
    sections: [
      { type: "h2", text: "Premier réflexe : ne pas tirer la chasse en boucle" },
      { type: "p", text: "Si la cuvette est déjà pleine, arrêtez de tirer la chasse : vous risquez le débordement. Attendez quelques minutes que le niveau baisse un peu, et écopez si besoin avec un gobelet pour travailler sans tout inonder." },
      { type: "h2", text: "Méthode 1 : l'eau chaude et le liquide vaisselle" },
      { type: "p", text: "Versez une bonne dose de liquide vaisselle dans la cuvette, puis 2 à 3 litres d'eau chaude (pas bouillante, pour ne pas fissurer la céramique) versée de haut pour créer une pression. Laissez agir 15 minutes : le savon lubrifie, l'eau chaude ramollit le bouchon. Souvent, ça suffit." },
      { type: "h2", text: "Méthode 2 : la ventouse adaptée aux WC" },
      { type: "p", text: "Une ventouse classique d'évier est trop plate pour les WC. Il faut une ventouse à collerette (forme cloche) qui épouse le fond de la cuvette. Positionnez-la pour couvrir l'évacuation, puis pompez fermement une dizaine de fois sans casser le joint d'air. L'effet d'aspiration/pression décolle le bouchon." },
      { type: "h2", text: "Méthode 3 : le furet de plomberie" },
      { type: "p", text: "Si le bouchon résiste, le furet est l'arme ultime. Introduisez la tige flexible dans l'évacuation et tournez la manivelle pour faire avancer la spirale jusqu'à l'obstacle, puis percez-le ou ramenez-le. C'est la méthode des pros, accessible à tous." },
      {
        type: "amazon",
        titre: "Le matériel pour déboucher vos WC",
        produits: [
          { nom: "Ventouse WC à collerette", description: "Forme cloche adaptée à la cuvette, bien plus efficace qu'une ventouse plate", recherche: "ventouse wc collerette debouchage" },
          { nom: "Furet de plomberie manuel", description: "Tige flexible 3 à 5 m avec manivelle pour les bouchons profonds", recherche: "furet plomberie manuel debouchage" },
          { nom: "Pompe à déboucher haute pression", description: "Alternative à la ventouse, pression d'air puissante", recherche: "pompe deboucheur haute pression wc" },
          { nom: "Gants de ménage épais", description: "Pour travailler proprement et en sécurité", recherche: "gants menage epais nitrile" },
        ],
      },
      { type: "h2", text: "Ce qu'il ne faut surtout pas faire" },
      { type: "p", text: "Évitez les déboucheurs chimiques à base de soude dans les WC : ils sont dangereux, polluants, peu efficaces sur un bouchon de papier et peuvent abîmer les joints. Si rien ne fonctionne après le furet, le bouchon est sans doute plus loin dans la canalisation : c'est là qu'un plombier devient utile." },
      {
        type: "cta",
        text: "Bouchon tenace ? Comparez les tarifs d'un plombier",
        href: "/plombier",
      },
    ],
  },
  {
    slug: "purger-radiateur-chauffage-soi-meme",
    title: "Purger un radiateur soi-même : le geste qui réchauffe (et économise)",
    description: "Radiateur froid en haut, chaud en bas ? Il faut le purger. Tutoriel simple en 10 minutes pour chasser l'air, mieux chauffer et réduire la facture.",
    metier: "chauffagiste",
    date: "2026-06-05",
    readTime: 5,
    intro:
      "Un radiateur qui reste froid en haut alors qu'il est chaud en bas, qui glougloute ou met une éternité à chauffer : c'est de l'air emprisonné dans le circuit. La solution s'appelle la purge, et c'est l'un des gestes d'entretien les plus simples et les plus rentables qui soient. Comptez 10 minutes par radiateur, une fois par an avant l'hiver.",
    sections: [
      { type: "h2", text: "Pourquoi purger ses radiateurs" },
      { type: "p", text: "L'air accumulé dans les radiateurs empêche l'eau chaude de circuler dans toute la surface. Résultat : le radiateur chauffe mal, la chaudière force davantage et la facture grimpe. Purger rétablit la circulation et peut faire gagner plusieurs pourcents sur la consommation de chauffage." },
      { type: "h2", text: "Quand et dans quel ordre" },
      { type: "p", text: "Purgez une fois par an, idéalement à l'automne avant de relancer le chauffage. Dans une maison à étages, commencez par les radiateurs du bas et finissez par ceux du haut. Coupez le chauffage et laissez refroidir l'installation avant de commencer." },
      { type: "h2", text: "Étape par étape" },
      { type: "p", text: "Placez un récipient et un chiffon sous le purgeur (la petite vis carrée ou à tête plate en haut d'un côté du radiateur). Ouvrez doucement avec la clé de purge : l'air s'échappe en sifflant. Dès que de l'eau coule en filet régulier sans bulles, refermez. Passez au radiateur suivant." },
      {
        type: "amazon",
        titre: "Le petit matériel pour purger",
        produits: [
          { nom: "Clé de purge multi-radiateurs", description: "S'adapte aux purgeurs carrés standards de tous radiateurs", recherche: "cle de purge radiateur multifonction" },
          { nom: "Purgeur automatique", description: "Évacue l'air en continu, plus aucune purge manuelle", recherche: "purgeur automatique radiateur" },
          { nom: "Manomètre de pression chauffage", description: "Pour vérifier et réajuster la pression du circuit", recherche: "manometre pression chaudiere chauffage" },
          { nom: "Set chiffons microfibre", description: "Pour éponger sans tacher le mur ou le sol", recherche: "chiffons microfibre menage lot" },
        ],
      },
      { type: "h2", text: "Après la purge : vérifier la pression" },
      { type: "p", text: "Purger fait baisser la pression du circuit. Vérifiez le manomètre de la chaudière : il doit afficher environ 1 à 1,5 bar à froid. Si la pression est trop basse, rajoutez de l'eau via le robinet de remplissage jusqu'à la bonne valeur. C'est essentiel pour que tout fonctionne correctement." },
      { type: "h2", text: "Quand appeler un chauffagiste" },
      { type: "p", text: "Si malgré la purge un radiateur reste froid, si l'eau qui sort est très noire (boues dans le circuit, désembouage nécessaire) ou si la pression chute sans cesse, c'est le signe d'un problème plus profond qui justifie l'intervention d'un professionnel." },
      {
        type: "cta",
        text: "Entretien chaudière ou désembouage ? Trouvez un chauffagiste",
        href: "/chauffagiste",
      },
    ],
  },
  {
    slug: "poser-papier-peint-debutant",
    title: "Poser du papier peint sans bulles : le guide du débutant",
    description: "Première pose de papier peint ? Préparation, encollage, raccords : la méthode complète pour un résultat net, sans bulles ni décalage. Outils inclus.",
    metier: "peintre",
    date: "2026-06-05",
    readTime: 7,
    intro:
      "Le papier peint fait un retour remarqué, et bonne nouvelle : poser un lé droit et sans bulle est largement à la portée d'un débutant soigneux. Tout se joue dans la préparation et dans le bon matériel. Voici la méthode pas à pas pour habiller un mur comme un pro, sans raccords qui sautent aux yeux.",
    sections: [
      { type: "h2", text: "Préparer le mur, l'étape qu'on bâcle à tort" },
      { type: "p", text: "Un beau papier peint commence par un mur propre, sec et lisse. Rebouchez les trous, poncez les aspérités, dépoussiérez. Sur un mur neuf ou poreux, appliquez une sous-couche pour uniformiser l'absorption de la colle. Repérez aussi la verticale avec un niveau : on ne se fie jamais à l'angle du mur, rarement droit." },
      { type: "h2", text: "Choisir le bon type de papier" },
      { type: "p", text: "L'intissé est le plus simple pour débuter : on encolle directement le mur (et non le lé), c'est plus propre et plus rapide. Le papier traditionnel demande d'encoller le lé et de le laisser détremper : plus technique. Pour une première fois, l'intissé est vivement conseillé." },
      {
        type: "amazon",
        titre: "Le kit complet pour poser du papier peint",
        produits: [
          { nom: "Kit outils pose papier peint", description: "Spatule maroufleur, roulette à joints, cutter et fil à plomb", recherche: "kit outils pose papier peint" },
          { nom: "Colle papier peint intissé", description: "Prête à l'emploi ou en poudre, adaptée à l'intissé", recherche: "colle papier peint intisse" },
          { nom: "Niveau à bulle et règle", description: "Pour tracer la verticale du premier lé", recherche: "niveau a bulle regle aluminium" },
          { nom: "Table à tapisser pliante", description: "Plan de travail stable pour encoller et couper", recherche: "table a tapisser pliante" },
        ],
      },
      { type: "h2", text: "Poser le premier lé : tout en dépend" },
      { type: "p", text: "Tracez une ligne verticale au crayon à un lé de l'angle de départ. Encollez le mur (intissé) sur une largeur un peu supérieure au lé. Appliquez le papier en suivant le trait, lissez du centre vers les bords avec la spatule maroufleur pour chasser les bulles. Arasez le haut et le bas au cutter contre une règle." },
      { type: "h2", text: "Soigner les raccords" },
      { type: "p", text: "Posez chaque lé bord à bord (jamais superposé pour l'intissé), en faisant correspondre le motif. Passez la roulette à joints sur la jonction sans appuyer comme une brute. Essuyez immédiatement les bavures de colle avec une éponge humide : sèche, elle laisse des traces brillantes." },
      {
        type: "cta",
        text: "Grande surface ou plafond ? Comparez les peintres-décorateurs",
        href: "/peintre",
      },
    ],
  },
  {
    slug: "monter-meuble-kit-reussir",
    title: "Monter un meuble en kit sans s'arracher les cheveux",
    description: "Meuble en kit qui résiste ? Tri des pièces, bons outils, astuces anti-galère : la méthode pour un montage solide et rapide, sans vis en trop à la fin.",
    metier: "menuisier",
    date: "2026-06-05",
    readTime: 5,
    intro:
      "Le meuble en kit, c'est pratique et économique… jusqu'au moment où l'on se retrouve avec une étagère à l'envers et trois vis en rab. Pourtant, avec un minimum de méthode et les bons outils, le montage devient simple et même satisfaisant. Voici comment éviter les pièges classiques et obtenir un meuble qui ne bouge pas.",
    sections: [
      { type: "h2", text: "Avant de commencer : trier et lire" },
      { type: "p", text: "Ouvrez le carton sur une surface dégagée et un sol protégé. Triez toute la visserie dans des coupelles par type (vis, tourillons, excentriques). Comptez les pièces avec la notice avant de visser quoi que ce soit : il est plus facile de signaler une pièce manquante maintenant qu'à mi-parcours." },
      { type: "h2", text: "Les bons outils changent tout" },
      { type: "p", text: "La clé Allen fournie est une punition pour les poignets. Une visseuse électrique avec embouts adaptés divise le temps de montage par trois et ménage vos mains. Réglez le couple sur une valeur basse pour ne pas arracher les filetages dans l'aggloméré." },
      {
        type: "amazon",
        titre: "Les outils qui facilitent le montage",
        produits: [
          { nom: "Visseuse électrique sans fil", description: "Avec réglage de couple pour ne pas abîmer l'aggloméré", recherche: "visseuse electrique sans fil reglage couple" },
          { nom: "Coffret embouts de vissage", description: "Tous les embouts (cruciforme, plat, Allen, Torx)", recherche: "coffret embouts vissage assortiment" },
          { nom: "Maillet caoutchouc", description: "Pour emboîter tourillons et panneaux sans marquer le bois", recherche: "maillet caoutchouc bricolage" },
          { nom: "Équerre de menuisier", description: "Pour vérifier les angles droits pendant l'assemblage", recherche: "equerre menuisier 90 degres" },
        ],
      },
      { type: "h2", text: "L'ordre de montage : la règle d'or" },
      { type: "p", text: "Suivez scrupuleusement l'ordre de la notice, même si une étape semble inutile. Ne serrez pas à fond les vis tant que la structure n'est pas entièrement assemblée : un léger jeu permet d'ajuster les angles. Une fois le meuble carré, repassez serrer l'ensemble." },
      { type: "h2", text: "Fixer au mur : ne jamais zapper" },
      { type: "p", text: "Bibliothèques, commodes hautes, étagères : la fixation antibasculement au mur n'est pas une option, surtout avec des enfants. Utilisez l'équerre fournie et des chevilles adaptées à votre mur (placo, brique, béton). C'est ce qui transforme un meuble bancal en meuble sûr et durable." },
      {
        type: "cta",
        text: "Montage complexe ou sur-mesure ? Trouvez un menuisier",
        href: "/menuisier",
      },
    ],
  },
  {
    slug: "installer-detecteur-fumee-norme",
    title: "Installer un détecteur de fumée aux normes : où et comment",
    description: "Le détecteur de fumée (DAAF) est obligatoire. Où le placer, comment le fixer, quel modèle choisir : le guide complet pour une installation conforme.",
    metier: "electricien",
    date: "2026-06-05",
    readTime: 5,
    intro:
      "Le détecteur de fumée normalisé (DAAF) est obligatoire dans tous les logements depuis 2015. Au-delà de la loi, c'est l'équipement qui sauve des vies en alertant pendant le sommeil. L'installer soi-même prend dix minutes et ne demande aucune compétence en électricité pour les modèles à pile. Encore faut-il le placer au bon endroit.",
    sections: [
      { type: "h2", text: "Combien et où en installer" },
      { type: "p", text: "La loi impose au minimum un détecteur par logement, mais l'idéal est d'en placer un par étage et dans les couloirs desservant les chambres. La fumée monte : fixez le détecteur au plafond, au point le plus haut, à au moins 30 cm des murs et des angles." },
      { type: "h2", text: "Les pièces à éviter" },
      { type: "p", text: "N'installez pas de détecteur de fumée dans la cuisine ni la salle de bain : vapeurs de cuisson et de douche déclenchent de fausses alertes. Pour la cuisine, on utilise plutôt un détecteur de chaleur. Évitez aussi la proximité immédiate des bouches d'aération qui dispersent la fumée." },
      { type: "h2", text: "Choisir un bon modèle" },
      { type: "p", text: "Vérifiez la norme EN 14604 (obligatoire) sur l'emballage. Privilégiez un modèle à pile longue durée (lithium 10 ans scellée) : plus de pile à changer chaque année, et un signal sonore quand elle approche de la fin. Les modèles avec bouton test et silence temporaire sont les plus pratiques au quotidien." },
      {
        type: "amazon",
        titre: "Détecteurs et accessoires conformes",
        produits: [
          { nom: "Détecteur de fumée NF EN 14604", description: "Pile lithium 10 ans scellée, conforme à la réglementation", recherche: "detecteur fumee nf en 14604 pile 10 ans" },
          { nom: "Détecteur de chaleur cuisine", description: "Pour la cuisine, sans fausse alerte à la cuisson", recherche: "detecteur chaleur cuisine daaf" },
          { nom: "Lot de détecteurs interconnectés", description: "Tous les détecteurs sonnent en même temps", recherche: "detecteurs fumee interconnectes lot" },
          { nom: "Embase aimantée de fixation", description: "Pose sans perçage au plafond", recherche: "fixation aimantee detecteur fumee sans percage" },
        ],
      },
      { type: "h2", text: "Entretien et durée de vie" },
      { type: "p", text: "Testez chaque détecteur une fois par mois avec le bouton dédié, et dépoussiérez-le deux fois par an à l'aspirateur. Un DAAF a une durée de vie d'environ 10 ans : remplacez-le à la date indiquée, même s'il semble fonctionner. La cellule de détection s'use avec le temps." },
      {
        type: "cta",
        text: "Installation électrique à revoir ? Comparez les électriciens",
        href: "/electricien",
      },
    ],
  },
  {
    slug: "refaire-joint-silicone-salle-de-bain",
    title: "Refaire un joint silicone de salle de bain : net et étanche",
    description: "Joint de baignoire ou de douche noirci ? Apprenez à le retirer et à appliquer un nouveau joint silicone bien lisse et durable, sans moisissures.",
    metier: "carreleur",
    date: "2026-06-05",
    readTime: 6,
    intro:
      "Un joint silicone qui noircit, se décolle ou laisse passer l'eau, c'est inesthétique et risqué pour le mur derrière. Le refaire soi-même coûte quelques euros et garantit une salle de bain saine. Le secret d'un joint net et durable tient en trois mots : retirer entièrement l'ancien, bien préparer, lisser d'un geste continu.",
    sections: [
      { type: "h2", text: "Retirer l'ancien joint en entier" },
      { type: "p", text: "C'est l'étape la plus longue mais la plus importante. Avec un couteau à joint ou un cutter, décollez tout l'ancien silicone, sans en laisser de résidus. Un dissolvant de silicone facilite le travail sur les restes tenaces. Un joint posé par-dessus l'ancien ne tiendra pas et moisira vite." },
      { type: "h2", text: "Nettoyer, sécher, dégraisser" },
      { type: "p", text: "Nettoyez la zone à fond, traitez les éventuelles moisissures avec un produit anti-moisissure, rincez et surtout séchez parfaitement : le silicone n'adhère pas sur une surface humide. Un passage à l'alcool ménager dégraisse et garantit l'accroche." },
      {
        type: "amazon",
        titre: "Le matériel pour un joint silicone parfait",
        produits: [
          { nom: "Cartouche silicone sanitaire anti-moisissure", description: "Spécial pièces humides, traité fongicide", recherche: "silicone sanitaire anti moisissure salle de bain" },
          { nom: "Pistolet à mastic", description: "Pour une application régulière du cordon", recherche: "pistolet a mastic silicone" },
          { nom: "Kit lisseur de joint silicone", description: "Spatules profilées pour un joint net du premier coup", recherche: "kit lisseur joint silicone spatule" },
          { nom: "Dissolvant et couteau à joint", description: "Pour retirer proprement l'ancien silicone", recherche: "dissolvant silicone couteau a joint" },
        ],
      },
      { type: "h2", text: "Appliquer le nouveau joint" },
      { type: "p", text: "Coupez l'embout de la cartouche en biseau au diamètre voulu. Posez du ruban de masquage de chaque côté de la jonction pour une ligne nette. Appliquez le silicone d'un geste continu et régulier, sans à-coups, en poussant le pistolet devant vous." },
      { type: "h2", text: "Lisser puis laisser sécher" },
      { type: "p", text: "Lissez immédiatement avec le lisseur (ou un doigt savonneux) en un seul passage. Retirez le ruban de masquage tant que le silicone est frais. Ne touchez plus à rien et respectez le temps de séchage indiqué (souvent 24 h) avant de remettre de l'eau au contact." },
      {
        type: "cta",
        text: "Carrelage à reprendre aussi ? Trouvez un carreleur",
        href: "/carreleur",
      },
    ],
  },
  {
    slug: "entretenir-tondeuse-gazon-saison",
    title: "Entretenir sa tondeuse : le geste qui prolonge sa durée de vie",
    description: "Tondeuse qui démarre mal ou coupe mal ? Lame, bougie, filtre, huile : l'entretien de base à faire chaque saison pour une tonte nette et un moteur qui dure.",
    metier: "jardinier-paysagiste",
    date: "2026-06-05",
    readTime: 6,
    intro:
      "Une tondeuse bien entretenue démarre au premier coup, coupe net et dure dix ans de plus. À l'inverse, une lame émoussée déchire l'herbe au lieu de la couper, ce qui jaunit la pelouse. L'entretien de base se fait en début et en fin de saison, sans compétence particulière. Voici le programme complet.",
    sections: [
      { type: "h2", text: "Toujours commencer par la sécurité" },
      { type: "p", text: "Avant toute intervention, coupez le moteur et débranchez l'antiparasite de la bougie (tondeuse thermique) ou la batterie / le secteur (tondeuse électrique). Une lame peut tourner d'un quart de tour et blesser. Travaillez avec des gants épais." },
      { type: "h2", text: "Affûter ou changer la lame" },
      { type: "p", text: "La lame est l'élément clé d'une coupe nette. Une fois par saison, démontez-la et affûtez-la à la lime ou remplacez-la si elle est ébréchée. Une lame bien affûtée coupe l'herbe franchement ; une lame émoussée la mâche et favorise les maladies du gazon." },
      {
        type: "amazon",
        titre: "Le nécessaire d'entretien de la tondeuse",
        produits: [
          { nom: "Lame de tondeuse universelle", description: "Vérifiez la longueur et le type de fixation de votre modèle", recherche: "lame tondeuse gazon universelle" },
          { nom: "Bougie d'allumage tondeuse", description: "À remplacer chaque saison sur les modèles thermiques", recherche: "bougie allumage tondeuse thermique" },
          { nom: "Filtre à air et huile moteur 4 temps", description: "Pour un moteur qui démarre et tourne propre", recherche: "filtre air huile moteur tondeuse 4 temps" },
          { nom: "Lime et gants de jardinage", description: "Pour affûter la lame en sécurité", recherche: "lime affutage lame gants jardinage" },
        ],
      },
      { type: "h2", text: "Vidange, filtre et bougie (modèles thermiques)" },
      { type: "p", text: "Sur une tondeuse à essence, faites la vidange de l'huile une fois par an (moteur tiède, l'huile s'écoule mieux), changez ou nettoyez le filtre à air encrassé et remplacez la bougie. Ces trois gestes simples résolvent l'immense majorité des démarrages capricieux." },
      { type: "h2", text: "Nettoyer le carter et hiverner" },
      { type: "p", text: "Après chaque tonte, retirez l'herbe collée sous le carter (moteur coupé) : séchée, elle bloque l'éjection. En fin de saison, videz le carburant ou ajoutez un stabilisateur, nettoyez à fond et rangez au sec. Votre tondeuse repartira sans broncher au printemps." },
      {
        type: "cta",
        text: "Pas le temps ? Comparez les jardiniers-paysagistes",
        href: "/jardinier-paysagiste",
      },
    ],
  },
  {
    slug: "laver-voiture-maison-comme-pro",
    title: "Laver sa voiture à la maison comme un pro (sans rayer)",
    description: "Lavage maison qui micro-raye la carrosserie ? La méthode des deux seaux, les bons produits et l'ordre des étapes pour une voiture nickel et préservée.",
    metier: "lavage-auto",
    date: "2026-06-05",
    readTime: 6,
    intro:
      "Laver sa voiture soi-même, c'est économique et gratifiant — à condition de ne pas la couvrir de micro-rayures avec une éponge qui balade le sable d'un endroit à l'autre. Les détailers pros suivent une méthode précise, accessible à tous, qui nettoie en profondeur sans agresser le vernis. Voici comment faire.",
    sections: [
      { type: "h2", text: "La règle d'or : la méthode des deux seaux" },
      { type: "p", text: "Un seau d'eau savonneuse, un seau d'eau claire pour rincer le gant entre chaque passage. Ainsi, la saleté décrochée part dans le seau de rinçage au lieu de revenir sur la carrosserie. Une grille de fond de seau piège les particules et les empêche de remonter sur le gant." },
      { type: "h2", text: "Toujours de haut en bas" },
      { type: "p", text: "Commencez par rincer abondamment pour retirer le gros des poussières. Lavez ensuite du toit vers le bas de caisse : les bas de caisse sont les plus sales, on les garde pour la fin pour ne pas ramener leur crasse en haut. Rincez par sections avant que le savon ne sèche." },
      {
        type: "amazon",
        titre: "L'équipement pour un lavage sans rayures",
        produits: [
          { nom: "Gant de lavage microfibre", description: "Bien plus doux qu'une éponge, retient la saleté sans rayer", recherche: "gant lavage auto microfibre" },
          { nom: "Kit deux seaux avec grilles", description: "La base de la méthode anti-rayures des pros", recherche: "kit deux seaux lavage auto grille" },
          { nom: "Shampooing auto pH neutre", description: "Nettoie sans attaquer cires et vernis", recherche: "shampoing auto ph neutre" },
          { nom: "Microfibres de séchage", description: "Grandes microfibres absorbantes pour sécher sans traces", recherche: "microfibre sechage voiture grande" },
        ],
      },
      { type: "h2", text: "Sécher pour éviter les traces" },
      { type: "p", text: "Ne laissez jamais la voiture sécher à l'air libre : l'eau calcaire laisse des auréoles. Épongez avec une grande microfibre de séchage par tamponnement, sans frotter. Une voiture bien séchée garde un brillant net et prépare l'étape suivante." },
      { type: "h2", text: "Protéger avec une cire" },
      { type: "p", text: "Une fois propre et sèche, une cire ou un spray protecteur fait perler l'eau, limite l'accroche des salissures et facilite les lavages suivants. À renouveler tous les deux à trois mois. C'est ce petit geste qui distingue une carrosserie qui vieillit bien." },
      {
        type: "cta",
        text: "Lavage complet ou rénovation ? Trouvez un centre près de chez vous",
        href: "/lavage-auto",
      },
    ],
  },
  {
    slug: "changer-essuie-glaces-voiture-soi-meme",
    title: "Changer ses essuie-glaces soi-même en 5 minutes",
    description: "Essuie-glaces qui laissent des traces ou couinent ? On les change soi-même en 5 minutes, sans outil et pour bien moins cher qu'au garage. Tuto simple.",
    metier: "garagiste",
    date: "2026-06-05",
    readTime: 4,
    intro:
      "Des essuie-glaces qui laissent des traînées, sautent ou couinent, c'est un vrai problème de sécurité par temps de pluie. Bonne nouvelle : les remplacer est l'une des opérations d'entretien les plus simples qui soient, sans aucun outil, en cinq minutes. Inutile de payer la main-d'œuvre d'un garage pour ça.",
    sections: [
      { type: "h2", text: "Quand les changer" },
      { type: "p", text: "On change ses balais d'essuie-glaces environ une fois par an, ou dès qu'ils laissent des traces, des zones non essuyées ou émettent un bruit de broutement. Le caoutchouc durcit avec le soleil et le gel : même peu utilisés, ils vieillissent." },
      { type: "h2", text: "Identifier la bonne taille et la bonne fixation" },
      { type: "p", text: "Les balais avant ont souvent deux longueurs différentes (côté conducteur plus long). Notez les dimensions inscrites sur l'ancien balai ou consultez le manuel du véhicule. Vérifiez aussi le type de fixation (crochet U, à baïonnette, push button) : c'est ce qui détermine la compatibilité." },
      {
        type: "amazon",
        titre: "Essuie-glaces et accessoires",
        produits: [
          { nom: "Balais d'essuie-glaces aérodynamiques", description: "Vérifiez la taille et le type de fixation de votre voiture", recherche: "balais essuie glaces flat blade voiture" },
          { nom: "Balai d'essuie-glace arrière", description: "Souvent oublié, à changer aussi", recherche: "balai essuie glace arriere voiture" },
          { nom: "Liquide lave-glace concentré", description: "À diluer selon la saison, anti-traces", recherche: "liquide lave glace concentre" },
          { nom: "Rénovateur de balais d'essuie-glace", description: "Pour prolonger un peu des balais encore corrects", recherche: "renovateur balais essuie glace" },
        ],
      },
      { type: "h2", text: "Le remplacement pas à pas" },
      { type: "p", text: "Relevez le bras d'essuie-glace à la verticale. Appuyez sur la languette de la fixation et faites coulisser l'ancien balai vers le bas pour le libérer. Clipsez le nouveau jusqu'au déclic, vérifiez qu'il tient bien, puis rabattez doucement le bras sur le pare-brise. Protégez le pare-brise d'un chiffon pendant l'opération, au cas où le bras retombe." },
      { type: "h2", text: "Pendant qu'on y est" },
      { type: "p", text: "Profitez-en pour faire l'appoint de liquide lave-glace et nettoyer le pare-brise à fond : un verre propre améliore nettement l'efficacité des balais neufs et la visibilité de nuit." },
      {
        type: "cta",
        text: "Révision ou panne ? Comparez les garagistes",
        href: "/garagiste",
      },
    ],
  },
  {
    slug: "nettoyer-gouttiere-toiture-soi-meme",
    title: "Nettoyer ses gouttières soi-même : sécurité et bons outils",
    description: "Gouttières bouchées par les feuilles ? Débordements et infiltrations à la clé. La méthode pour les nettoyer en sécurité, et quand confier ça à un couvreur.",
    metier: "couvreur",
    date: "2026-06-05",
    readTime: 5,
    intro:
      "Des gouttières pleines de feuilles et de mousse débordent, font ruisseler l'eau le long des murs et finissent par provoquer des infiltrations coûteuses. Un nettoyage deux fois par an, à l'automne surtout, suffit à éviter ces dégâts. C'est faisable soi-même sur une maison de plain-pied ou à un étage, à condition de respecter quelques règles de sécurité.",
    sections: [
      { type: "h2", text: "La sécurité avant tout" },
      { type: "p", text: "La première cause d'accident domestique grave, c'est la chute d'échelle. Utilisez une échelle stable, posée sur sol plat, idéalement maintenue par une seconde personne. Ne vous penchez jamais sur le côté : mieux vaut redescendre et déplacer l'échelle. Au-delà d'un étage ou sur toit pentu, on ne tente rien soi-même." },
      { type: "h2", text: "Retirer les déchets" },
      { type: "p", text: "À la main gantée ou avec une petite pelle à gouttière, retirez feuilles, mousse et branchages, en partant du point haut vers la descente. Déposez les déchets dans un seau accroché à l'échelle plutôt que de les jeter au sol à l'aveugle." },
      {
        type: "amazon",
        titre: "Le matériel pour nettoyer les gouttières",
        produits: [
          { nom: "Kit nettoyage gouttière télescopique", description: "Perche et brosse pour nettoyer depuis le sol", recherche: "kit nettoyage gouttiere telescopique" },
          { nom: "Grille anti-feuilles pour gouttière", description: "Empêche les feuilles de s'accumuler à nouveau", recherche: "grille anti feuilles gouttiere" },
          { nom: "Échelle stabilisateur / écarteur", description: "Sécurise l'appui de l'échelle contre la façade", recherche: "stabilisateur echelle ecarteur gouttiere" },
          { nom: "Gants et seau de chantier", description: "Pour travailler proprement et en sécurité", recherche: "gants chantier seau maconnerie" },
        ],
      },
      { type: "h2", text: "Rincer et vérifier l'écoulement" },
      { type: "p", text: "Une fois les gros déchets retirés, rincez la gouttière au jet vers la descente pour évacuer les résidus et vérifier que l'eau s'écoule librement. Si l'eau stagne, la descente est bouchée : un furet ou un jet puissant dans le tuyau de descente règle le problème." },
      { type: "h2", text: "Prévenir avec des grilles" },
      { type: "p", text: "Pour espacer les nettoyages, posez des grilles ou des protections anti-feuilles sur les gouttières. Elles laissent passer l'eau mais bloquent les feuilles. Sous les arbres, c'est un investissement vite rentabilisé en temps et en tranquillité." },
      {
        type: "cta",
        text: "Toit haut ou gouttière endommagée ? Faites appel à un couvreur",
        href: "/couvreur",
      },
    ],
  },
